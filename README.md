...
**Random Greetings** This application generates random greeting messages, built with Rails and React on two different apps.
...
- [Link](https://github.com/George7h/hello-react-frontend) to Hello-Rails-Frondend Application.
...
```sh
  git clone git@github.com:George7h/hello-rails-back-end.git
